    ...
    return (
        <section id="work-section" className="min-h-screen py-12">
            ...
            <ul className="projects" ref={projectsList}>
                {projects.map(
                    ({ title, type, description, features, media, tech, btnLink, repoUrl }: project, index: number) => {
                        return (
                            <li
                                key={`project-${index}`}
                                className={`project flex flex-col-reverse md:flex-row gap-10 py-10 ${
                            ...
                            >
                                ...
                                <div className="basis-1/2 flex flex-col gap-4">
                                    <div>
                                        ...
                                        {type && (
                                            <span className="ms-2 italic text-base font-sans font-light">{type}</span>
                                        )}
                                    </div>
                                    {tech && tech.length ? (
